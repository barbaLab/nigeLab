...
% ProbeChannel    = blockObj.ID.ProbeChannel;
paths.RW_N      = fullfile(paths.RW,  [blockObj.Name blockObj.ID.Raw.File  '.mat']);
paths.FW_N      = fullfile(paths.FW,  [blockObj.Name blockObj.ID.Filt.File '.mat']);
