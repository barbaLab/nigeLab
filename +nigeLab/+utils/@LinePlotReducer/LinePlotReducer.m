...
% Becomes:
%
% nigeLab.utils.LinePlotReducer(t, x, 'r:', t, y, 'b', 'LineWidth', 3);
%
% Note that LinePlotReducer returns a LinePlotReducer object as output.
%
% lpr = nigeLab.utils.LinePlotReducer(t, x);
%
...
%
% h_plots = nigeLab.utils.reduce_plot(t, x);
%
...
%
% nigeLab.utils.LinePlotReducer(@stairs, t, x);
%
...
%
% h = plot(t, x, 'r:');
% nigeLab.utils.LinePlotReducer(h);
%
...
% nigeLab.utils.LinePlotReducer(h, t, x, t, y);
%
...
%
% lpe = nigeLab.utils.LinePlotExplorer(gcf(), 0, 5);
%
...
% ---
%
%  Note: this version has been (very slightly) modified from the original 
%        to incorporate into the "package" format within `nigeLab.utils`
%
% Copyright 2015, The MathWorks, Inc. and Tucker McClure
    ...
    methods
        ...
        function o = LinePlotReducer(varargin)
            ...
            width = nigeLab.utils.get_axes_width(o.h_axes);
            o.last_width = width;
            o.last_lims  = [-inf inf];

            % Reduce the data!
            for k = 1:length(o.y)
                [x_r{k}, y_r{k}] = nigeLab.utils.reduce_to_width(...
                    o.x{o.y_to_x_map(k)}(:), ...
                    o.y{k}(:), ...
                    width, ...
                    [-inf inf]);
    ...
    methods
        ...
        function RefreshData(o,force)
            ...
            width = nigeLab.utils.get_axes_width(o.h_axes(1));
            ...
            for k = 1:length(o.h_plot)
                ...
                % Reduce the data.
                [x_r, y_r] = nigeLab.utils.reduce_to_width(...
                   o.x{o.y_to_x_map(k)}(:), ...
                   o.y{k}(:), ...
                   width, lims);
