...
%        associated graphics objects into.
   ...
   properties (Dependent,Transient,Hidden,Access=public)
      EventTimes           double            % All "Event" Event-type DiskData variables for this trial
      ...
      Meta                 double            % All "Meta" Event-Type DiskData variables for this trial
   ...
   % TRANSIENT,PROTECTED (graphics objects)
   ...
   methods (Access={?nigeLab.Block,?nigeLab.nigelObj})
      ...
      function obj = behaviorInfo(blockObj,nigelPanelObj)
         ...
         % Fill the past value colors
%          for i = 1:obj.TrialIndex
%             updateObjColors(obj,i);
%          end
%          updateObjLabels(obj,1:numel(obj.Variable));
   ...
   methods 
      ...
      % [DEPENDENT]  Assigns .Header property (cannot)
      function set.Header(~,~)
         %SET.HEADER  Does nothing
      end
      ...
      function value = get.OutcomeVarName(obj)
         ...
         value = 'Outcome'; % Default value
         if isempty(obj.Block)
            return;
         elseif isempty(obj.Block.Pars.Event.OutcomeVarName)
            return;
         end
   ...
   methods (Access=public)      
      ...
      function toggleTrialMask(obj)
         ...
         if obj.TrialIndex == iCapped   % Then we didn't move
            ...
            setTrial(obj,nan,obj.TrialIndex);
         end
      ...
      function setTrial(obj,src,newTrialIndex)
         ...
         obj.TrialButtonArray(curTrial).EdgeColor = 'none';
         obj.TrialIndex = newTrialIndex;
         
         % Add "selected" highlight to new button
         obj.TrialButtonArray(newTrialIndex).EdgeColor = 'y';
   ...
   methods (Access=protected)
      ...
      function buildProgressTracker(obj)
         ...
         for i = 1:obj.NTotal
            ...
            obj.TrialButtonArray = horzcat(obj.TrialButtonArray,...
               ...
               pos,num2str(i),{@obj.setTrial,nan,i},...
               'Position',pos,...
               'FontUnits','points',...
               'FontSize',13,...
               'FontColor','none',...
         ...
         setButton(obj.TrialButtonArray,obj.TrialIndex,...
            'EdgeColor',nigeLab.defaults.nigelColors('g'));
      ...
      function updateObjColors(obj,curTrial)
         ...
         if isnan(obj.Outcome(curTrial))
            tCol = nigeLab.defaults.nigelColors('light');
         else
            tCol = getAltColor(obj,'b','r',obj.Outcome(curTrial));
         end
         ...
         obj.TrialButtonArray(curTrial).FaceColorEnable = tCol;
