   ...
   methods (Hidden,Access=public)
      ...
      function printTimingData(obj,evt)
         ...
         nigeLab.libs.VidGraphics.printPropLine(obj.Block,...
            {'TrialIndex','VideoIndex'},{'(Trial Index)','(Overall Index)'});
         if isempty(mod)
            axObj = obj.TimeAxes;
            ...
            nigeLab.libs.VidGraphics.printPropLine(obj,...
               ...
               [{'(Overall Index)','(<strong>Within-Series</strong> Index)'}, ...
                repmat({'(sec)'},1,7)]);
            nigeLab.libs.VidGraphics.printPropLine(axObj,...
               {'TrialIndex','FrameTime','NeuTime','TrialOffset','VideoOffset','NeuOffset'},...
               [{'(Trial Index)'},repmat({'(sec)'},1,5)]);
            nigeLab.libs.VidGraphics.printPropLine(camObj,...
               {'Index','Time','SeriesTime_','SeriesTime__','NeuTime_'},...
               [{'(<strong>Within-Series</strong> Index)'},repmat({'(sec)'},1,4)]);
   ...
   methods (Access=protected)
      ...
      function buildHeadsUpDisplay(obj)
         ...
         obj.TrialOffsetLabel = uicontrol(obj.Panel.Panel,...
            ...
            'String', sprintf('Gross Offset: %6.3f sec  ||  FPS: %6.2f Hz',...
                        obj.GrossOffset,obj.FPS),...
            'FontName','Droid Sans',...
            'FontSize',14,...
            'FontWeight','normal',...
