...
%          obj.VidGraphicsObj.VideoOffset = value;
   ...
   methods (Access=public)
      ...
      function addBoundsIndicators(obj)
         %ADDBoundsIndicatorS  Adds "boundary indicator" patches
         %
         %  addBoundsIndicators(obj);
...
%          curX = unscaledX * obj.DX_ / obj.x.axes_scaling;
         ...
         if obj.flags.BeingDragged
            ...
            obj.BoundsIndicator.XData = ...
               obj.BoundsIndicator.UserData.x + obj.NeuOffset ...
                  + obj.x.delta_offset;
            drawnow;
         end
      end
...
%             obj.Figure.WindowButtonMotionFcn = @(s,~)cursorMotionCB(obj,s,obj.x.orig);
            ...
            src.Color = obj.dig(src.UserData.index).shaded_col;
            src.LineStyle = ':';
            src.LineWidth = 2.5;         
         end
