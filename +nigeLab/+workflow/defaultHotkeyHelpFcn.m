...
pairs = struct( ...
   ...
   't',        ['Set or reach frame (Reach == current ts)' newline...
   ...
   'e',        ['Set Forelimb as "Right" (Forelimb == 1). ' newline ...
                sprintf('\t\t\t') '--> Press [alt + e] to set ALL trials as "Right"' newline], ...
   'q',        ['Set Forelimb as "Left" (Forelimb == 0). ' newline ...
                sprintf('\t\t\t') '--> Press [alt + q] to set ALL trials as "Left"' newline], ...
