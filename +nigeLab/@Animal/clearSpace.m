function flag = clearSpace(animalObj,ask,Choice)
...
%% GUI
   ...
   Bu = uicontrol(F,'Style','pushbutton','Units','normalized',...
      'Position',[.75 .1 .15 .05],...
      'String','Delete!','Callback',{@DeleteStuff,cbk,ask,B,animalObj});
else
   DeleteStuff([],[],Choice,ask,B,animalObj);
end
...
function DeleteStuff(~,~,usrchoice,ask,B,animalObj)
