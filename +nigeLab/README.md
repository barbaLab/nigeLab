...
2. A lot of analysis packages are "by engineers, for engineers." A personal goal of mine is to create tools "by engineers, for non-engineers." In my mind, one aspect of that is creating tools that allow useful analyses or increase productivity without ever having to enter jargon into a console. The goal of this package is to extend powerful tools for electrophysiological pre-processing, analysis, and metadata tracking using a relatively simple and straightforward interface. To that end, the two main kinds of objects you need to learn about to get up and running with this package are the "Tank" and "Block" objects (nomenclature shamelessly borrowed from TDT).  
	...
	* [**Tank**](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank)
	...
	* [**Block**](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block)
...
2. Select the parent folder that contains your individual recording files (e.g. Intan *.rhd or *.rhs files, or TDT block folders). This is the [Tank](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank).
3. A graphical interface (in progress...) will populate with all viable recordings and associated metadata. These are the [Blocks](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block). Dropdown menus will populate with options to configure processing steps such as:
...
Brief example calls to methods used by Tank class. For more detailed descriptions, visit the Tank [class folder](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank "@Tank") or try entering the following into the Matlab command window for more detailed documentation:   

```Matlab
doc nigeLab.Tank
```

### List of Tank Methods ###
[Tank](#tank-1)  
[convert](#convert)  
[list](#list)  
[tankGet](#tankget)    
...
#### [Tank](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank#tank-1 "Tank Class constructor") ####  
Construct the Tank Class object.

```Matlab
tank = nigeLab.Tank; % Will prompt Tank selection UI
```  

```Matlab
tank = nigeLab.Tank('DIR','C:/Tank/Folder/Path');
```  
---  
  
#### [convert](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank#convert "Convert raw files") ####  
...
### [list](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank#list "List of Blocks in Tank") ###  
...
#### [tankGet](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank#tankget "Get Tank property") ####  
...
#### [tankSet](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Tank#tankset "Set Tank property") ####  
...
Brief example calls to methods used by Block class. For more detailed descriptions, visit the Block [class folder](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block "@Block") or try entering the following into the Matlab command window for more detailed documentation:  
```Matlab
doc nigeLab.Block
```  
...
#### [Block](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#block-1 "Block Class constructor") ####  
...
```Matlab
block = nigeLab.Block; % Will bring up Block selection UI
```

```Matlab
block = nigeLab.Block('DIR','C:/Block/Folder/Path');
```
---  
  
#### [blockGet](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#blockget "Get Block property") ####  
...
#### [blockSet](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#blockset "Set Block property") ####  
...
#### [list](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#list "List files in Block") ####  
...
#### [loadClusters](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#loadclusters "Load spike clusters") ####  
...
#### [loadSorted](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#loadsorted "Load sorted spike classes") ####  
...
#### [loadSpikes](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#loadspikes "Load detected spikes") ####  
...
#### [plotSpikes](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#plotspikes "Plot spike cluster waveform snippets") ####  
...
#### [plotWaves](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#plotwaves "Plot data stream snippet") ####  
...
#### [syncBehavior](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#syncbehavior "Synchronize behavioral and neural data") ####   
---  
  
#### [takeNotes](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#takenotes "Add/View Notes") ####  
...
#### [updateContents](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#updatecontents "Update Block contents") ####  
...
#### [updateID](https://github.com/m053m716/ePhys_packages/tree/master/%2BnigeLab/%40Block#updateid "Modify ID tokens for Block") ####  
...
[DataPipeline_Overview]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/DataPipeline_Overview.JPG "Fig. 1: Generic experimental pipeline"
[DataPipeline_Recording]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/DataPipeline_Recording.JPG "Fig. 1a: Data collected during experiments"
[DataPipeline_Conversion]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/DataPipeline_Conversion.JPG "Fig. 1b: Conversion of data from binary to Matlab-compatible file format"
[DataPipeline_Analysis]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/DataPipeline_Analysis.JPG "Fig. 1c: Extraction of features of interest and hypothesis-testing"

[TankStructure_Initial]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/TankBlockHierarchy_Initial.JPG "Fig. 2: Raw Tank acquisition hierarchy"
[TankStructure_Processed]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/TankBlockHierarchy_Overview.JPG "Fig. 3: Processed Tank-Block hierarchy"

[BlockStructure_Overview]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/BlockStructure_Overview.JPG "Fig. 4: Block file hierarchy"
[BlockStructure_Base]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/BlockStructure_Base.JPG "Fig. 4a: Block parent folder"
[BlockStructure_HighSampleRateStreams]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/BlockStructure_HighSampleRateStreams.JPG "Fig. 4c: High sample rate streams"
[BlockStructure_LowSampleRateStreams]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/BlockStructure_LowSampleRateStreams.JPG "Fig. 4d: Low sample rate streams"
[BlockStructure_SnippetFeatures]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/BlockStructure_SnippetFeatures.JPG "Fig. 4e: Spike detection, clustering, and sorting"
[BlockStructure_BehaviorSyncData]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/BlockStructure_BehaviorSyncData.JPG "Fig. 4f: Digital inputs for behavioral synchronization to neural data"

[NamingConvention_Example]: https://github.com/m053m716/ePhys_packages/blob/master/%2BnigeLab/img/NamingConvention_Example.JPG "Fig. 4b: Naming convention used by the Nudo Lab at KUMC"
