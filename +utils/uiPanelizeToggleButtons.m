function h = uiPanelizeToggleButtons(parent,nBox,pos,nCol,val,xOffset,yOffset)
%% UIPANELIZETICKBOXES Returns axes cell array, with panelized axes objects
%
%  h = UIPANELIZETOGGLEBUTTONS(parent,nBox,pos);
%  h = UIPANELIZETOGGLEBUTTONS(parent,nBox,pos,nCol);
%  h = UIPANELIZETOGGLEBUTTONS(parent,nBox,pos,nCol,val);
%  h = UIPANELIZETOGGLEBUTTONS(parent,nBox,pos,nCol,val,xOffset);
%  h = UIPANELIZETOGGLEBUTTONS(parent,nBox,pos,nCol,val,xOffset,yOffset);
%
%  --------
%   INPUTS
%  --------
...
for ii = 1:nBox
   ...
   p = [xpos ypos(rem(ii-1,nRow)+1) widthBox heightBox];
